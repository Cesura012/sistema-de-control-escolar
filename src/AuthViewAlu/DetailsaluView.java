...
public class DetailsaluView {
	...
	private void initialize() {
		...
		lblNewLabel_7.setBounds(30, 283, 100, 14);
		...
		panel_4.setBounds(570, 72, 250, 300);
		...
		btnNewButton_1.setToolTipText("Descargar informacion");
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frame, "Informacion descargada", "Créditos",
						JOptionPane.INFORMATION_MESSAGE);
			}
		});
		btnNewButton_1.setForeground(new Color(255, 255, 255));
		btnNewButton_1.setBackground(new Color(0, 64, 128));
		btnNewButton_1.setBounds(607, 383, 170, 40);
		panel.add(btnNewButton_1);

		JButton btnNewButton_2 = new JButton("Generar credencial");
		btnNewButton_2.setToolTipText("Generar credencial");
		btnNewButton_2.setForeground(new Color(255, 255, 255));
		btnNewButton_2.setBackground(new Color(0, 64, 128));
		btnNewButton_2.setBounds(607, 434, 170, 40);
