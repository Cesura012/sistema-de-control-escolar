...
public class RegisterdoView {
	...
	private void initialize() {
		...
		panel_3.setBounds(180, 60, 500, 368);
		panel.add(panel_3);
		panel_3.setLayout(null);

		table = new JTable();
		table.setBackground(new Color(176, 216, 255));
		table.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "ID Docente", "Nombre completo" }));
		...
		btnNewButton_1.setToolTipText("Detalles del docente");
