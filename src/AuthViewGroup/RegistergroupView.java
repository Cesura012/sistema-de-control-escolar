...
public class RegistergroupView {
	...
	private void initialize() {
		...
		panel_3.setBounds(180, 70, 500, 360);
		panel.add(panel_3);

		String titles[] = { "N° control", "Nombre completo" };
		String data[][] = { { "19310556", "Leonardo Gutierrez" }, { "19310492", "Sugey Lara" },
				{ "19310556", "Daniel Martínez Martínez" }, { "19310134", "Alan Aramburo Peña" },
				{ "19310249", "Alonso Piñas Colada" }, { "N° control", "Nombre completo" },
				{ "N° control", "Nombre completo" }, { "N° control", "Nombre completo" },
				{ "N° control", "Nombre completo" }, { "N° control", "Nombre completo" },
				{ "N° control", "Nombre completo" }, { "N° control", "Nombre completo" },
				{ "N° control", "Nombre completo" }, { "N° control", "Nombre completo" },
				{ "N° control", "Nombre completo" }, { "N° control", "Nombre completo" },
		...
		btnNewButton_1.setToolTipText("Detalles de alumno");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedRow != -1) {
					...
					detailsgroupView.getTextField().setText(fullName); // Por ejemplo, asigna el nombre completo al
																		// campo de texto correspondiente en
																		// DetailsaluView
					// Similarmente, puedes asignar otros datos del alumno a los campos de texto
					// correspondientes en DetailsaluView
				} else {
					JOptionPane.showMessageDialog(frame, "Por favor selecciona un alumno de la tabla.", "Error",
							JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		btnNewButton_1.setBounds(330, 457, 203, 35);
