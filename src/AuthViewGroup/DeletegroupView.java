...
public class DeletegroupView {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(0, 0, 872, 31);
		...
		lblNewLabel_6.setBounds(30, 219, 150, 14);
		panel_3.add(lblNewLabel_6);

		textField_6 = new JTextField();
		textField_6.setBounds(205, 219, 200, 20);
		...
		table_scroll.setBounds(0, 10, 420, 300);
		...
		JLabel lblNewLabel_1_1 = new JLabel("Seleccione grupo");
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frame, "Cancelar acción", "Créditos", JOptionPane.INFORMATION_MESSAGE);
