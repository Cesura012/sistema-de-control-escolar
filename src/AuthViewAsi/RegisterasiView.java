...
public class RegisterasiView {
	...
	private void initialize() {
		...
		panel_3.setBounds(184, 76, 500, 346);
		panel.add(panel_3);

		String titles[] = { "Lista de asignaturas" };
		String data[][] = { { "Matematicas" }, { "Metodos numericos" }, { "ingles" }, { "Programacion" },
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedRow != -1) {
					...
					detailsasiView.getTextField().setText(fullName); // Por ejemplo, asigna el nombre completo al campo
																		// de texto correspondiente en DetailsaluView
		...
		btnNewButton_1.setBounds(350, 457, 170, 36);
