...
public class RegisterView {
	...
	private void initialize() {
		...
		panelc.setBounds(220, 50, 300, 337);
		layeredPane.add(panelc, JLayeredPane.PALETTE_LAYER);
		panelc.setLayout(null);

		JLabel img2 = new JLabel("");
		img2.setBounds(110, 11, 89, 89);
		...
		emailField.setBounds(36, 135, 202, 24);
		...
		lblNewLabel_1.setBounds(36, 170, 139, 24);
		panelc.add(lblNewLabel_1);

		passwordField = new JPasswordField();
		passwordField.setBounds(36, 195, 202, 20);
		...
		lblNewLabel_2.setBounds(36, 226, 202, 20);
		panelc.add(lblNewLabel_2);

		confirmPasswordField = new JPasswordField();
		confirmPasswordField.setBounds(36, 249, 202, 20);
